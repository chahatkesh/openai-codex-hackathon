...
const endpoint = `${apiBaseUrl}/mcp/sse`;
  ...
  return (
    <section className="space-y-6">
      ...
      <ol className="space-y-3 rounded-xl border border-white/10 bg-[color:var(--surface)] p-5 text-sm text-[color:var(--text-muted)]">
        <li>1. Open Codex MCP settings and add a new SSE server.</li>
        <li>2. Set endpoint URL to the FuseKit MCP SSE URL shown below.</li>
